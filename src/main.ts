...
document.getElementById("moveNorth")?.addEventListener("click", () => movePlayer(1, 0));
document.getElementById("moveSouth")?.addEventListener("click", () => movePlayer(-1, 0));
document.getElementById("moveEast")?.addEventListener("click", () => movePlayer(0, 1));
document.getElementById("moveWest")?.addEventListener("click", () => movePlayer(0, -1));
...
function drawGrid(i: number, j: number) {
  ...
  zone.on("click", () => {
    ...
    return;
      ...
      zone.bindTooltip(`${heldToken}`, { permanent: true, direction: "center" });
